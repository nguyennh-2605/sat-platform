...
// Khởi tạo Gemini API (process.env.GEMINI_API_KEY phải được load ở index.js)
...
// Tạo luồng phản hồi (stream) cho chatbot giải thích (Toán, Thơ, Bảng, Ảnh)
exports.createChatStream = async ({ message, history, context }) => {
