...
| Dashboard Home | `dashboard/default`, `dashboard/crm` | `dashboard/academy`, `dashboard/productivity` | Role-dispatched; Admin uses real KPI/chart/attention/snapshot data plus a Studio-style AuditEvent Recent Activity table; Teacher and Student retain dedicated workspace homes; visual QA pending |
