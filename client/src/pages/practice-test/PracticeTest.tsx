...
import { ArrowUpDown, BookOpen, BookOpenCheck, Check, CheckCircle2, ChevronLeft, ChevronRight, Clock3, Grid2X2, GraduationCap, List, LoaderCircle, Play, RefreshCw, SlidersHorizontal, X } from 'lucide-react';
...
import { Badge, Button, Card, EmptyState, Modal, PageHeader, Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '../../components/ui/AppUI';
import { DataPagination, DataSurface, DataToolbar, DataToolbarActions, DataToolbarSearch } from '@/components/ui/data-surface';
...
function PracticeToolbar({ search, onSearchChange, subject, onSubjectChange, mode, onModeChange, classFilter, onClassChange, classes, sortOrder, onSortChange, activeFilterCount, onResetFilters, viewMode, onViewModeChange, loading, onRefresh }: PracticeToolbarProps) {
  return <DataToolbar>
    <DataToolbarSearch value={search} onChange={event => onSearchChange(event.target.value)} placeholder="Search tests…" label="Search tests" />
    <DataToolbarActions>
