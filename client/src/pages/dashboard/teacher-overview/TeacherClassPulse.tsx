  ...
  return <Card>
    ...
    <CardContent className="px-0">
      ...
      <Table className="min-w-176">
        <TableHeader><TableRow><TableHead>Class</TableHead><TableHead className="text-right">Students</TableHead><TableHead className="text-right">Completion</TableHead><TableHead className="text-right">Average score</TableHead><TableHead className="text-right">Attention</TableHead><TableHead className="w-12" /></TableRow></TableHeader>
