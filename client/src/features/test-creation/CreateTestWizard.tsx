              ...
              <Card className="flex min-h-[620px] flex-1 flex-col overflow-hidden !border-[#C9D8D2]">
                ...
                <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-2">
                  <section className="flex min-h-[520px] min-w-0 flex-col border-b border-[#C9D8D2] lg:border-b-0 lg:border-r">
                    ...
                    <textarea ref={editorRef} value={rawText} onChange={event => setRawText(event.target.value)} readOnly={editLocked} spellCheck={false} className="min-h-0 flex-1 resize-none bg-white p-4 font-mono text-xs leading-6 text-[#1A1A1A] outline-none placeholder:text-[#9CA3AF] read-only:cursor-not-allowed read-only:bg-[#F9FAFB] focus:bg-[#FCFEFD]" placeholder={activeImportTemplate} />
                  </section>
